...
static void {{name}}_menu();

// TODO:  Implement
extern char* decode_{{name}}_datainterchange(int inputSelector, int outputSelector, char *file_path);
...
static void {{name}}_menu()
{
    ...
    /* Functions to test */
    decode_{{name}}_datainterchange_file2file(in_encoding, out_encoding,in_file_path, out_file_path); // ✅
    // decode_{{name}}_datainterchange_buffer2file(in_encoding,out_encoding, *buffer, size, out_file_path); // ✅
    // int encoded_bytes = decode_{{name}}_datainterchange_buffer2buffer(in_encoding,out_encoding, *buffer, size, &out_buffer);); // ✅
    // int encoded_bytes = decode_{{name}}_datainterchange_file2buffer(in_encoding, out_encoding, in_file_path, &out_buffer); // ✅
}
...
extern int decode_{{name}}_datainterchange_file2file(int input_encoding, int output_encoding, char *file_path, char *newfileName){
...
extern int decode_{{name}}_datainterchange_buffer2file(int input_encoding, int output_encoding, char *in_buffer, unsigned long long in_buffer_size, char *new_filename){
...
extern int decode_{{name}}_datainterchange_file2buffer(int input_encoding, int output_encoding, char *file_path, char** out_buffer)
{
    DataInterChange_t *decoded_content = decode_datainterchange_file(input_encoding, file_path);
...
extern int decode_{{name}}_datainterchange_buffer2buffer(int input_encoding, int output_encoding, char *in_buffer, unsigned long long in_buffer_size, char** out_buffer)
{
    size_t size = (size_t)in_buffer_size;
