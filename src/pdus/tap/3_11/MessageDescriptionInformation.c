...
asn_TYPE_member_t asn_MBR_MessageDescriptionInformation_1[] = {
...
static const int asn_MAP_MessageDescriptionInformation_oms_1[] = { 0, 1 };
static const ber_tlv_tag_t asn_DEF_MessageDescriptionInformation_tags_1[] = {
	(ASN_TAG_CLASS_APPLICATION | (143 << 2)),
	(ASN_TAG_CLASS_UNIVERSAL | (16 << 2))
};
static const asn_TYPE_tag2member_t asn_MAP_MessageDescriptionInformation_tag2el_1[] = {
    { (ASN_TAG_CLASS_APPLICATION | (141 << 2)), 0, 0, 0 }, /* messageDescriptionCode */
    { (ASN_TAG_CLASS_APPLICATION | (142 << 2)), 1, 0, 0 } /* messageDescription */
};
asn_SEQUENCE_specifics_t asn_SPC_MessageDescriptionInformation_specs_1 = {
	...
	asn_MAP_MessageDescriptionInformation_oms_1,	/* Optional members */
	2, 0,	/* Root/Additions */
