...
/* InitiatingParty */
typedef long	 InitiatingParty_t;
...
jer_type_encoder_f InitiatingParty_encode_jer;
oer_type_decoder_f InitiatingParty_decode_oer;
oer_type_encoder_f InitiatingParty_encode_oer;
per_type_decoder_f InitiatingParty_decode_uper;
per_type_encoder_f InitiatingParty_encode_uper;
per_type_decoder_f InitiatingParty_decode_aper;
per_type_encoder_f InitiatingParty_encode_aper;
