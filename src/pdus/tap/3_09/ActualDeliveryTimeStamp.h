...
jer_type_encoder_f ActualDeliveryTimeStamp_encode_jer;
oer_type_decoder_f ActualDeliveryTimeStamp_decode_oer;
oer_type_encoder_f ActualDeliveryTimeStamp_encode_oer;
per_type_decoder_f ActualDeliveryTimeStamp_decode_uper;
per_type_encoder_f ActualDeliveryTimeStamp_encode_uper;
per_type_decoder_f ActualDeliveryTimeStamp_decode_aper;
per_type_encoder_f ActualDeliveryTimeStamp_encode_aper;
