...
asn_TYPE_member_t asn_MBR_ChargeInformationList_1[] = {
	{ ATF_POINTER, 0, 0,
...
static const ber_tlv_tag_t asn_DEF_ChargeInformationList_tags_1[] = {
	(ASN_TAG_CLASS_APPLICATION | (70 << 2)),
	(ASN_TAG_CLASS_UNIVERSAL | (16 << 2))
};
asn_SET_OF_specifics_t asn_SPC_ChargeInformationList_specs_1 = {
