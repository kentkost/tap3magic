...
asn_TYPE_member_t asn_MBR_GprsCall_1[] = {
	{ ATF_POINTER, 7, offsetof(struct GprsCall, typeOfControllingNode),
	...
	{ ATF_POINTER, 4, offsetof(struct GprsCall, equipmentInformation),
...
static const int asn_MAP_GprsCall_oms_1[] = { 0, 1, 2, 3, 4, 5, 6 };
...
static const asn_TYPE_tag2member_t asn_MAP_GprsCall_tag2el_1[] = {
    ...
    { (ASN_TAG_CLASS_APPLICATION | (235 << 2)), 5, 0, 0 } /* valueAddedServiceUsedList */
};
