...
/* CalledCountryCode */
typedef NumberString_t	 CalledCountryCode_t;
...
jer_type_encoder_f CalledCountryCode_encode_jer;
oer_type_decoder_f CalledCountryCode_decode_oer;
oer_type_encoder_f CalledCountryCode_encode_oer;
per_type_decoder_f CalledCountryCode_decode_uper;
per_type_encoder_f CalledCountryCode_encode_uper;
per_type_decoder_f CalledCountryCode_decode_aper;
per_type_encoder_f CalledCountryCode_encode_aper;
