...
struct InternetServiceProviderId;

/* InternetServiceProviderIdList */
typedef struct InternetServiceProviderIdList {
	A_SEQUENCE_OF(struct InternetServiceProviderId) list;
...
extern asn_SET_OF_specifics_t asn_SPC_InternetServiceProviderIdList_specs_1;
extern asn_TYPE_member_t asn_MBR_InternetServiceProviderIdList_1[1];
