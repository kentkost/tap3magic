...
static const int asn_MAP_GeographicalLocation_oms_1[] = { 0, 1, 2, 3 };
...
static const asn_TYPE_tag2member_t asn_MAP_GeographicalLocation_tag2el_1[] = {
    { (ASN_TAG_CLASS_APPLICATION | (134 << 2)), 3, 0, 0 }, /* latitude */
    { (ASN_TAG_CLASS_APPLICATION | (137 << 2)), 1, 0, 0 }, /* servingLocationDescription */
    { (ASN_TAG_CLASS_APPLICATION | (139 << 2)), 2, 0, 0 }, /* longitude */
    { (ASN_TAG_CLASS_APPLICATION | (198 << 2)), 0, 0, 0 } /* servingBid */
};
