...
asn_TYPE_member_t asn_MBR_TrackedCustomerIdentification_1[] = {
...
static const int asn_MAP_TrackedCustomerIdentification_oms_1[] = { 0, 1 };
static const ber_tlv_tag_t asn_DEF_TrackedCustomerIdentification_tags_1[] = {
	(ASN_TAG_CLASS_APPLICATION | (372 << 2)),
	(ASN_TAG_CLASS_UNIVERSAL | (16 << 2))
};
static const asn_TYPE_tag2member_t asn_MAP_TrackedCustomerIdentification_tag2el_1[] = {
    { (ASN_TAG_CLASS_APPLICATION | (363 << 2)), 0, 0, 0 }, /* customerIdType */
    { (ASN_TAG_CLASS_APPLICATION | (364 << 2)), 1, 0, 0 } /* customerIdentifier */
};
asn_SEQUENCE_specifics_t asn_SPC_TrackedCustomerIdentification_specs_1 = {
	...
	asn_MAP_TrackedCustomerIdentification_oms_1,	/* Optional members */
	2, 0,	/* Root/Additions */
